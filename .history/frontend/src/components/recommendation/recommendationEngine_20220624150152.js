...
export const RecommendationEngine = (props) => {
  ...
  const [recommendationText, setRecommendationText] = useState(" noo");
  ...
  useEffect(async () => {
    ...
    if (materialSelected == true){
      ...
      console.log(localStorage.getItem("API_Recommendation_Accepted"));
      ...
      console.log(localStorage.getItem("recomm_transaction"));
