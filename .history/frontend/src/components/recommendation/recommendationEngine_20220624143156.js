      ...
      <CardContent display="flex">
        ...
        >
          <ButtonGroup disableElevation variant="contained" sx={{ height: 60,fontSize:20, width:'20%'}}>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0, backgroundColor:"#FF0000" }} theme={themeButton} onClick={handleReject} color={reject ? "primary" : "secondary"}>Reject</Button>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0, backgroundColor:"#00CC00" }} onClick={handleAccept} color={reject ? "primary" : "secondary"}>Agree</Button>
          </ButtonGroup>
