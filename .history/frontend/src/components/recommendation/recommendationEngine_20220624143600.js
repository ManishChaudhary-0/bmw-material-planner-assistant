...
// const themeButton2 = createTheme({
//   palette: {
//     primary: {
//       // Purple and green play nicely together.
//       main:"#00CC00",
    ...
    <Card {...props} className={classStyle.card}>
      ...
      <CardContent display="flex">
        ...
        <Box
          ...
          alignItems="flex-end"
        >
          <ButtonGroup disableElevation variant="contained" theme={themeButton}  sx={{ height: 60,fontSize:20, width:'20%'}}>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0}} onClick={handleReject} color={reject ? "primary" : "secondary"}>Reject</Button>
            <Button sx={{width:'50%', fontSize:20, fontWeight:0}} onClick={handleAccept} color={reject ? "primary" : "secondary"}>Agree</Button>
          </ButtonGroup>
